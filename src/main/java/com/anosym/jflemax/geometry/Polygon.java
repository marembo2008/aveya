...
public class Polygon implements Serializable {
    ...
    public void addLine(Line line) {
        if (polygonLineBounds == null) {
            polygonLineBounds = new ArrayList<>();
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.polygonLineBounds != other.polygonLineBounds && (this.polygonLineBounds == null || !this.polygonLineBounds.equals(
                other.polygonLineBounds))) {
            return false;
        }
        return true;
    }
